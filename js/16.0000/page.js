    ...
    if ("app" in global) {
        ...
        defer.addProperties({
            updateContainer: function (placeholder, element, state) {
                ...
                if (this.elementExists(placeholder) && this.elementExists(element)) {
            ...
            setContainer: function (placeholder) {
                ...
                return Object.create({}, {
                   show: {
                       value: this.updateContainer.bind(this, placeholder, element, true)
                   },
                   hide: {
                       value: this.updateContainer.bind(this, placeholder, element, false)
                   }
                });
            },
            revealContainers: function () {
                const placeholders = app.toArray(document.querySelectorAll(".defer"));
        ...
        app.require(["observer"], function () {
            ...
            app.observer.watch({
                selector: ".view--add-smooth-scroll",
                inRange: function () {
                    document.getElementById('dtm').className += " "+"has-smooth-scroll";
                },
                unObserve: false,
                options: {
                    threshold: 0.1
        ...
        app.listen(document.querySelectorAll(".expando > .expando__toggle"), function () {
        ...
        order.addProperties({
            ...
            buttons: order.toArray(document.querySelectorAll("[href^='#order']")),
