(function (global) {
    if ("app" in global) {
        ...
        addEventListener("SessionLoaded", function () {
            let v8Items = ["MAINTVDIS", "MAINMPDIS", "MAINBVDIS", "MAINMP", "MAINBV"];
            let hasV8Product = false;

            for (let i = 0; i < cart.cartItems.length; i++) {
                if (!hasV8Product) {
                    hasV8Product = (v8Items.indexOf(cart.cartItems[i]) > -1);
                }
            }
            ...
            if ((hasV8Product) ||
                ...
                let id = "product1";
                //pageCode === "BestValue" ? "product3" : "product2";
