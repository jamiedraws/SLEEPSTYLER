...
<%
    ...
    if (videos > 0)
    {
        ...
        %>
        <div class="media__video contain contain--video" title="Watch the video" id="vimeo-hero" data-src-iframe="https://player.vimeo.com/video/<%= firstVideo.Key %>?dnt=1"></div>
        <%
