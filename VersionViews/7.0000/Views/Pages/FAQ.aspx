...
<%
    ...
    var faqList = new List<FAQ>
    {
        ...
        new FAQ
        {
            ...
            Answer = @"<p>We recommend using Sun Joe detergents that are specifically formulated to work with your Sun Joe Xtream’s foamer cannon. We offer a 3-pack of Auto Snow Foam Detergents in three scents that whip up into a rich, snow foam lather to clean and shine your vehicle’s exterior. They’re great for cars, RVs, boats, SUVs, ATVs and more!</p>"
        },
        new FAQ
        {
            DisplayRank = 8,
