...
<div class="form c-brand--form" id="form">
    <%
        using (Html.BeginForm())
        {
            ...
            var mainItemDefault = pageCode == "BESTVALUE" ? "MAINBVDIS" : "MAINMPDIS";
            ...
            <div class="form__border">
                <div class="c-brand--form__fieldset">
                    ...
                    <div class="form__fieldset">
                        ...
                        <%
                            var isCheckedForMAINMP = mainItem.Contains("MAINMPDIS"); 
                        %>
                        <div id="most-popular" class="package package--unavailable">
                            <label for="product2" class="package__checkbox form__checkbox-label">
                               <input type="radio" data-item="<%=affirmPrefix %>MAINMPDIS" disabled id="product2" name="cartitem" class="cartRadio">
                               <span class="form__checkbox"></span>
                            </label>
                            <span class="package__copy">
                        ...
                        <%
                            var isCheckedForMAINBV = mainItem.Contains("MAINBVDIS"); 
                        %>
                        <div id="best-value" class="package package--unavailable">
                            <label for="product3" class="package__checkbox form__checkbox-label">
                                <input type="radio" data-item="<%=affirmPrefix %>MAINBVDIS" disabled id="product3" name="cartitem" class="cartRadio">
                                <span class="form__checkbox"></span>
                            </label>
                            <span class="package__copy">
