...
<% if (DtmContext.Page.IsStartPageType && DtmContext.Version == 9) { %>
    <link rel="stylesheet" href="/css/surveys/exit9.css<%= v %>" />
            ...
            <fieldset class="c-modal__fieldset">
                ...
                <a href="{{ url }}" class="c-modal__link">
                    <picture class="c-modal__picture">
                        <source srcset="/images/surveys/{{ id }}-mobile.png" media="(max-width: 500px)" />
                        <img src="/images/surveys/{{ id }}-desktop.png" alt="{{ description }}" />
                    </picture>
                </a>
                {{ #progress }}
    ...
    <script defer src="/js/surveys/exit9.js<%= v %>"></script>
<% } %>