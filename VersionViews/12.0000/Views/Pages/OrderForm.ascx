...
<div class="form c-brand--form" id="form">
    <%
        using (Html.BeginForm())
        {
            ...
            {
                { "BESTVALUE", "MAINBVDIS3" },
                { "TVOFFER", "MAINTVDIS" }
            };
            var filterMainItemDefault = mainItemDefaultDictionary.Where(i => i.Key == pageCode);
            var mainItemDefault = filterMainItemDefault.Any() ? filterMainItemDefault.Select(i => i.Value).FirstOrDefault() : "MAINMPDIS3";
        ...
        <div class="form__row view">
            ...
            <div class="form__border">
                <div class="c-brand--form__fieldset">
                    ...
                    <div class="form__fieldset">
                        <%
                            var isCheckedForMAINTV = mainItem.Contains("MAINTVDIS");
                        %>
                        <div id="main-offer" class="package <%= isCheckedForMAINTV ? "package--is-selected" : string.Empty %>">
                            <label for="product1" class="package__checkbox form__checkbox-label">
                               <input type="radio" data-item="<%=affirmPrefix %>MAINTVDIS" <%= isCheckedForMAINTV ? "checked" :  string.Empty%> id="product1" name="cartitem" class="cartRadio">
                            ...
                            <span class="package__copy">
                                ...
                                <span class="package__details">
                                    <%= Html.Partial("AffirmVerbiage", new ViewDataDictionary {
                                        ...
                                        { "amount", "21599" },
                                        { "message", @"<span class=""package__price-discount-of"">$239.99</span> $215.99 or 12 monthly payments of $21 <br>with" }
                                    }) %>
                                </span>
                            </span>
                        ...
                        <%
                            var isCheckedForMAINMP = mainItem.Contains("MAINMPDIS3"); 
                        %>
                        <div id="most-popular" class="package <%= isCheckedForMAINMP ? "package--is-selected" : string.Empty %>">
                            <label for="product2" class="package__checkbox form__checkbox-label">
                               <input type="radio" data-item="<%=affirmPrefix %>MAINMPDIS3"  <%= isCheckedForMAINMP ? "checked" :  string.Empty%> id="product2" name="cartitem" class="cartRadio">
                               <span class="form__checkbox"></span>
                            </label>
                            <span class="package__copy">
                                ...
                                <span class="package__details">
                                    <%= Html.Partial("AffirmVerbiage", new ViewDataDictionary {
                                        ...
                                        { "modifier", "package__affirm" },
                                        { "amount", "26997" },
                                        { "message", @"<span class=""package__price-discount-of"">$299.97</span> $269.97 or 12 monthly payments of $26 <br>with" }
                                    }) %>
                                 </span>
                            </span>
                        ...
                        <%
                            var isCheckedForMAINBV = mainItem.Contains("MAINBVDIS3"); 
                        %>
                        <div id="best-value" class="package package--fall <%= isCheckedForMAINBV ? "package--is-selected" : string.Empty %>">
                            <label for="product3" class="package__checkbox form__checkbox-label">
                                <input type="radio" data-item="<%=affirmPrefix %>MAINBVDIS3" <%= isCheckedForMAINBV ? "checked" :  string.Empty%> id="product3" name="cartitem" class="cartRadio">
                                <span class="form__checkbox"></span>
                            </label>
                            <span class="package__copy">
                                ...
                                <span class="package__details">
                                    <%= Html.Partial("AffirmVerbiage", new ViewDataDictionary {
                                        ...
                                        { "modifier", "package__affirm" },
                                        { "amount", "35996" },
                                        { "message", @"<span class=""package__price-discount-of"">$399.96</span> $359.96 or 12 monthly payments of $34 <br>with" }
                                    }) %>
                                </span>
                            </span>
