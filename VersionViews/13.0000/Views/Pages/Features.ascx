...
<%
    ...
    var featuresList = new SortedList<int, string>
    {
        ...
        {
            8, @"<strong>EASY, EMISSION-FREE OPERATION:</strong> Instantly and reliably starts by squeezing the trigger; includes 35&rsquo; power cord with GFCI protection and convenient on/off switch"
        }
    };
