        ...
        <div class="hero__group">
            ...
            <div class="hero__offer">
                ...
                <div class="hero__burst">
                    <picture class="hero__value contain contain--badge-value" data-src-img="/images/badge-value-660.jpg" data-attr='{ "alt" : "$660 value" }'>
                    </picture>
            ...
            <div class="hero__addons addons addons--extra">
                <div class="addons__section">
                    ...
                    <div class="slide slide--addons">
                        <div id="addons-slide" class="addons__group slide__into" data-slide-config='{ "displayAll" : "(min-width: 1000px)" }'>
                            <figure class="addons__item addons__item--turbo-nozzle slide__item">
                                <picture class="contain contain--addon-turbo-nozzle" data-src-img="/images/turbo-nozzle-replacement.jpg" data-attr='{ "aria-labelledby" : "addons-1" }'>
                                </picture>
                                <figcaption id="addons-1">
                                    <span>Turbo Spray</span>
                                    <span>Nozzle</span>
                                </figcaption>
                            </figure>
                            <figure class="addons__item addons__item--detergent-foam-cannon slide__item">
                                <picture class="contain contain--addon-detergent-foam-cannon" data-src-img="/images/product-detergent-foam-cannon.jpg" data-attr='{ "aria-labelledby" : "addons-2" }'>
                                </picture>
                            ...
                            <figure class="addons__item addons__item--spray-tips slide__item">
                                <picture class="contain contain--addon-spray-tips" data-src-img="/images/product-spray-tips.jpg" data-attr='{ "aria-labelledby" : "addons-3" }'>
                                </picture>
                            ...
                            <figure class="addons__item addons__item--hose slide__item">
                                <picture class="contain contain--addon-hose" data-src-img="/images/product-hose.jpg" data-attr='{ "aria-labelledby" : "addons-4" }'>
                                </picture>
                            ...
                            <figure class="addons__item addons__item--cleaning-bottle-pack slide__item">
                                <picture class="contain contain--addon-cleaning-bottle-pack" data-src-img="/images/cleaning-bottle-pack.jpg" data-attr='{ "aria-labelledby" : "addons-5" }'>
                                </picture>
                                <figcaption id="addons-5">
                                    <span>3 Pack of 1 Quart</span>
                                    <span>All Purpose Cleaner,</span>
                                    <span>Auto Foam,</span>
                                    <span>and Deck Wash</span>
                                </figcaption>
                            </figure>
                            <figure class="addons__item addons__item--power-cord slide__item">
                                <picture class="contain contain--addon-power-cord" data-src-img="/images/product-power-cord.jpg" data-attr='{ "aria-labelledby" : "addons-6" }'>
                                </picture>
                            ...
                            <figure class="addons__item addons__item--gutter-lance slide__item">
                                <picture class="contain contain--addon-gutter-lance" data-src-img="/images/gutter-lance.jpg" data-attr='{ "aria-labelledby" : "addons-7" }'>
                                </picture>
                                <figcaption id="addons-7">
                                    <span>9-Foot</span>
                                    <span>Sky Reach Lance</span>
                                    <span>With Gutter</span>
                                    <span>Cleaning Attachment</span>
                                </figcaption>
                            </figure>
                            <figure class="addons__item addons__item--steel-lance slide__item">
                                <picture class="contain contain--addon-steel-lance" data-src-img="/images/product-steel-lance.jpg" data-attr='{ "aria-labelledby" : "addons-8" }'>
                                </picture>
                                <figcaption id="addons-8">
                                    <span>Stainless Steel Lance</span>
                                    <span>with Solid</span>
