...
<div class="form c-brand--form" id="form">
    <%
        using (Html.BeginForm())
        {
            ...
            {
                { "BESTVALUE", "MAINBV3LOW" },
                { "TVOFFER", "MAINTVLOW" }
            };
            var filterMainItemDefault = mainItemDefaultDictionary.Where(i => i.Key == pageCode);
            var mainItemDefault = filterMainItemDefault.Any() ? filterMainItemDefault.Select(i => i.Value).FirstOrDefault() : "MAINMP3LOW";
            ...
            <div class="form__border">
                <div class="c-brand--form__fieldset">
                    ...
                    <div class="form__fieldset">
                        ...
                        <%
                            var isCheckedForMAINMP = mainItem.Contains("MAINMP3LOW"); 
                        %>
                        <div id="most-popular" class="package <%= isCheckedForMAINMP ? "package--is-selected" : string.Empty %>">
                            <label for="product2" class="package__checkbox form__checkbox-label">
                               <input type="radio" data-item="<%=affirmPrefix %>MAINMP3LOW"  <%= isCheckedForMAINMP ? "checked" :  string.Empty%> id="product2" name="cartitem" class="cartRadio">
                               <span class="form__checkbox"></span>
                            </label>
                            <span class="package__copy">
                        ...
                        <%
                            var isCheckedForMAINBV = mainItem.Contains("MAINBV3LOW"); 
                        %>
                        <div id="best-value" class="package <%= isCheckedForMAINBV ? "package--is-selected" : string.Empty %>">
                            <label for="product3" class="package__checkbox form__checkbox-label">
                                <input type="radio" data-item="<%=affirmPrefix %>MAINBV3LOW" <%= isCheckedForMAINBV ? "checked" :  string.Empty%> id="product3" name="cartitem" class="cartRadio">
                                <span class="form__checkbox"></span>
                            </label>
                            <span class="package__copy">
                                ...
                                <span class="package__details">
                                    <%= getOfferPricesByProductCode("MAINBV3LOW") %>
                                </span>
                            </span>
