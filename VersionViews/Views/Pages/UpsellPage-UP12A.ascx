...
<section class="upsell-card">
    <div class="upsell-card__group">
        <%
            var productUP12 = products.FirstOrDefault(p => string.Equals(p.ProductCode, "UP12", StringComparison.InvariantCultureIgnoreCase));
            var vimeoUP12Id = "438624832";
            var vimeoUP12Src = String.Format(vimeoSrc, vimeoUP12Id);
        %>
                ...
                <div class="slide slide--alpha">
                    <div class="slide__in">
                        <div id="beta" class="slide__into" aria-live="polite">
                            <picture id="beta-0" class="slide__item load-item" style="--arp: 1/1;" aria-hidden="false"><img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_0.jpg" alt="" class="slide__item"></picture>
                            <picture id="beta-1" class="slide__item load-item" style="--arp: 1/1;" aria-hidden="true"><img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_1.jpg" alt="" class="slide__item"></picture>
                            <picture id="beta-2" class="slide__item load-item" style="--arp: 1/1;" aria-hidden="true"><img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_2.jpg" alt="" class="slide__item"></picture>
                            <picture id="beta-3" class="slide__item load-item" style="--arp: 1/1;" aria-hidden="true"><img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_3.jpg" alt="" class="slide__item"></picture>
                        </div>
                    </div>
                    <nav aria-label="Product gallery" class="slide__thumbnails">
                        <a href="#beta-0" id="thumbnail_SPX_PCA10_UP12_0" data-slide-index="0" class="slide__thumbnail" style="--arp: 1/1;">
                            <img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_0.jpg" alt=""></a>
                        <a href="#beta-1" id="thumbnail_SPX_PCA10_UP12_1" data-slide-index="1" class="slide__thumbnail" style="--arp: 1/1;">
                            <img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_1.jpg" alt=""></a>
                        <a href="#beta-2" id="thumbnail_SPX_PCA10_UP12_2" data-slide-index="2" class="slide__thumbnail" style="--arp: 1/1;">
                            <img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_2.jpg" alt=""></a>
                        <a href="#beta-3" id="thumbnail_SPX_PCA10_UP12_3" data-slide-index="3" class="slide__thumbnail" style="--arp: 1/1;">
                            <img src="/images/upsells/SPX_PCA10_UP12/SPX_PCA10_3.jpg" alt=""></a>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="upsell-card__copy c-brand--upsell">
            <h2 class="c-brand__headline">DEEP CLEAN WITH EASE</h2>

            <div class="c-brand__txt">
                <p>Looking to save time when deep cleaning surfaces around your home? The Sun Joe® 10-Inch Patio Cleaning Attachment is your solution!</p>

                <p>Perfect for an endless array of projects - from porch to patio, driveways and decks, boats, pavers, bricks, BBQs and more! The durable, multi-purpose brush loosens grime, dirt and other debris. Includes transfer adapter for use with most pressure washers.</p>
            </div>
            <%
                Html.RenderPartial("UpsellActionCard", productUP12);
                Html.RenderPartial("UpsellActionCard", productUP12, snackbarLayout);
            %>
        </div>
    </div>
</section>
...
<section class="upsell-card">
    <div class="upsell-card__group">
        <%
            var productUP11 = products.FirstOrDefault(p => string.Equals(p.ProductCode, "UP11", StringComparison.InvariantCultureIgnoreCase));
            var vimeoUP11Id = "454797317";
            var vimeoUP11Src = String.Format(vimeoSrc, vimeoUP11Id);
        %>
        <div class="upsell-card__img c-brand__img">
            <div class="c-brand__upsell-carousel">
                <div class="slide slide--alpha">
        ...
        <div class="upsell-card__copy c-brand--upsell">
            ...
            <%
                Html.RenderPartial("UpsellActionCard", productUP11);
                Html.RenderPartial("UpsellActionCard", productUP11, snackbarLayout);
            %>
        </div>
    </div>
</section>
...
<input type="hidden" name="UP12hiddenQty" id="UP12hiddenQty" />
<input type="hidden" name="UP12Active" id="UP12Active" />
<script>

    function updateHiddenFields() {
        $('#UP12hiddenQty').val($('#UP12Qty').val());
        ...
        if ($('#UP12Btn').hasClass('added')) {
            $('#UP12Active').val('true');
        } else {
            $('#UP12Active').val('false');
        }
    }
