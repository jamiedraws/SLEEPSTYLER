...
<%
    ...
    var faqList = new List<FAQ>
    {
        ...
        new FAQ
        {
            ...
            Answer = @"<p>Our most popular detergent is our Auto Snow Foam, specially formulated to capture and gently rinse away dirt particles on your vehicle's exterior leaving a superior shine! You can add a 3 Quart Assortment of Auto Snow Foam to your order today that includes Pineapple, Orange-Vanilla, and Coconut scented Auto Snow Foam. </p>"
        },
        new FAQ
        {
            DisplayRank = 8,
